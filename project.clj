(defproject shoreleave/shoreleave-services "0.2.2-SNAPSHOT"
  :description "A smarter client-side with ClojureScript : Shoreleave's API for third-party remote services"
